...
public class GameManager : MonoBehaviour
{
    ...
    [Header("Info")]
    [SerializeField] private int NumberofChances;
    ...
    public int GetNumberofChances() { return NumberofChances; }
    ...
    public void SetNumberOfChances(int tmp_) {  NumberofChances = tmp_; }
